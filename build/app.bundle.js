...
function submitPost() {
  ...
  var data = {
    ...
    _ui.ui.showAlert('Please fill in all the fields', 'alert alert-danger');
  } else {

    // check for id
    if (id === '') {
      // Create post
      _http.http.post('http://localhost:3000/posts', data).then(function (date) {
      ...
      // Update Post
      _http.http.put('http://localhost:3000/posts/' + id, data).then(function (date) {
...
var UI = function () {
  ...
  _createClass(UI, [{
    ...
    value: function showAlert(message, className) {
      ...
      var container = document.querySelector(".postsContainer"); // Get parent
      var posts = document.querySelector('#posts'); // Get posts
    ...
    value: function changeFormState(type) {
      if (type === 'edit') {
        ...
        var cardForm = document.querySelector('.card-form'); // Get parent
        var formEnd = document.querySelector('.form-end'); // Get element to insert before
